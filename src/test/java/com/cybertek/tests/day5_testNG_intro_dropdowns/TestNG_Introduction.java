...
public class TestNG_Introduction {
    ...
    /*
    Before method will run one time before each test
     */
    @BeforeMethod
    ...
    /*
    After method will run one time after each test
     */
    @AfterMethod
    ...
    public void test3() {
        ...
        Assert.assertTrue(str1.equals(str2),"Comparing hello words failed");
